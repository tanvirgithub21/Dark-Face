...
const BottomNavbar = () => {
  ...
  return (
    <div className="fixed  top-0 left-1/2 -translate-x-1/2 w-full max-w-screen-md bg-white dark:bg-gray-800 shadow-md border-b border-[#0000001d] dark:border-[#ffffff14] flex justify-around items-center py-2 md:py-3 z-50">
      {/* Home Icon */}
      <button
