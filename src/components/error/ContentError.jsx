    ...
    <div>
      <div className="relative max-w-lg mx-auto space-y-2 bg-white dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 rounded-sm shadow-md ">
          ...
          <div className="h-64 w-full bg-gray-300 dark:bg-gray-600 rounded-sm mt-2 flex flex-col justify-center items-center text-center text-gray-300 dark:text-gray-200">
            <span className="text-sm">
              Video not found, enjoy another content
            </span>
